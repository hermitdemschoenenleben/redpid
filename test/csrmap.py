...
csr = {
    ...
    'fast_a_sequence_player_data_in': (0, 0x086, 14, True),
    'fast_a_sequence_player_data_addr': (0, 0x088, 14, True),
    'fast_a_sequence_player_enabled': (0, 0x08a, 1, True),
    'fast_a_sequence_player_recording': (0, 0x08b, 1, True),
    'fast_a_sequence_player_data_out': (0, 0x08c, 14, False),
    'fast_a_sequence_player_data_out_addr': (0, 0x08e, 14, True),
    'fast_a_x_clr': (0, 0x090, 1, True),
    'fast_a_x_max': (0, 0x091, 25, False),
    'fast_a_x_min': (0, 0x095, 25, False),
    'fast_a_y_clr': (0, 0x099, 1, True),
    'fast_a_y_max': (0, 0x09a, 25, False),
    'fast_a_y_min': (0, 0x09e, 25, False),
    'fast_a_sweep_trigger_clr': (0, 0x0a2, 1, True),
    'fast_a_sweep_trigger_max': (0, 0x0a3, 1, False),
    'fast_a_sweep_trigger_min': (0, 0x0a4, 1, False),
    'fast_a_x_hold_en': (0, 0x0a5, 27, True),
    'fast_a_x_clear_en': (0, 0x0a9, 27, True),
    'fast_a_y_hold_en': (0, 0x0ad, 27, True),
    'fast_a_y_clear_en': (0, 0x0b1, 27, True),
    'fast_a_relock_en': (0, 0x0b5, 27, True),
    'fast_a_dx_sel': (0, 0x0b9, 5, True),
    'fast_a_dy_sel': (0, 0x0ba, 5, True),
    'fast_a_rx_sel': (0, 0x0bb, 5, True),
    ...
    'fast_b_sequence_player_data_in': (1, 0x086, 14, True),
    'fast_b_sequence_player_data_addr': (1, 0x088, 14, True),
    'fast_b_sequence_player_enabled': (1, 0x08a, 1, True),
    'fast_b_sequence_player_recording': (1, 0x08b, 1, True),
    'fast_b_sequence_player_data_out': (1, 0x08c, 14, False),
    'fast_b_sequence_player_data_out_addr': (1, 0x08e, 14, True),
    'fast_b_x_clr': (1, 0x090, 1, True),
    'fast_b_x_max': (1, 0x091, 25, False),
    'fast_b_x_min': (1, 0x095, 25, False),
    'fast_b_y_clr': (1, 0x099, 1, True),
    'fast_b_y_max': (1, 0x09a, 25, False),
    'fast_b_y_min': (1, 0x09e, 25, False),
    'fast_b_sweep_trigger_clr': (1, 0x0a2, 1, True),
    'fast_b_sweep_trigger_max': (1, 0x0a3, 1, False),
    'fast_b_sweep_trigger_min': (1, 0x0a4, 1, False),
    'fast_b_x_hold_en': (1, 0x0a5, 27, True),
    'fast_b_x_clear_en': (1, 0x0a9, 27, True),
    'fast_b_y_hold_en': (1, 0x0ad, 27, True),
    'fast_b_y_clear_en': (1, 0x0b1, 27, True),
    'fast_b_relock_en': (1, 0x0b5, 27, True),
    'fast_b_dx_sel': (1, 0x0b9, 5, True),
    'fast_b_dy_sel': (1, 0x0ba, 5, True),
    'fast_b_rx_sel': (1, 0x0bb, 5, True),
    ...
    'root_sync_sequences_en': (8, 0x000, 27, True),
