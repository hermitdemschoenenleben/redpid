...
csr = {
    ...
    'fast_a_sequence_player_data_addr': (0, 0x088, 7, True),
    'fast_a_sequence_player_data_write': (0, 0x089, 1, True),
    'fast_a_sequence_player_enabled': (0, 0x08a, 1, True),
    'fast_a_x_clr': (0, 0x08b, 1, True),
    'fast_a_x_max': (0, 0x08c, 25, False),
    'fast_a_x_min': (0, 0x090, 25, False),
    'fast_a_y_clr': (0, 0x094, 1, True),
    'fast_a_y_max': (0, 0x095, 25, False),
    'fast_a_y_min': (0, 0x099, 25, False),
    'fast_a_sweep_trigger_clr': (0, 0x09d, 1, True),
    'fast_a_sweep_trigger_max': (0, 0x09e, 1, False),
    'fast_a_sweep_trigger_min': (0, 0x09f, 1, False),
    'fast_a_x_hold_en': (0, 0x0a0, 27, True),
    'fast_a_x_clear_en': (0, 0x0a4, 27, True),
    'fast_a_y_hold_en': (0, 0x0a8, 27, True),
    'fast_a_y_clear_en': (0, 0x0ac, 27, True),
    'fast_a_relock_en': (0, 0x0b0, 27, True),
    'fast_a_dx_sel': (0, 0x0b4, 5, True),
    'fast_a_dy_sel': (0, 0x0b5, 5, True),
    'fast_a_rx_sel': (0, 0x0b6, 5, True),
    ...
    'fast_b_sequence_player_data_addr': (1, 0x088, 7, True),
    'fast_b_sequence_player_data_write': (1, 0x089, 1, True),
    'fast_b_sequence_player_enabled': (1, 0x08a, 1, True),
    'fast_b_x_clr': (1, 0x08b, 1, True),
    'fast_b_x_max': (1, 0x08c, 25, False),
    'fast_b_x_min': (1, 0x090, 25, False),
    'fast_b_y_clr': (1, 0x094, 1, True),
    'fast_b_y_max': (1, 0x095, 25, False),
    'fast_b_y_min': (1, 0x099, 25, False),
    'fast_b_sweep_trigger_clr': (1, 0x09d, 1, True),
    'fast_b_sweep_trigger_max': (1, 0x09e, 1, False),
    'fast_b_sweep_trigger_min': (1, 0x09f, 1, False),
    'fast_b_x_hold_en': (1, 0x0a0, 27, True),
    'fast_b_x_clear_en': (1, 0x0a4, 27, True),
    'fast_b_y_hold_en': (1, 0x0a8, 27, True),
    'fast_b_y_clear_en': (1, 0x0ac, 27, True),
    'fast_b_relock_en': (1, 0x0b0, 27, True),
    'fast_b_dx_sel': (1, 0x0b4, 5, True),
    'fast_b_dy_sel': (1, 0x0b5, 5, True),
    'fast_b_rx_sel': (1, 0x0b6, 5, True),
