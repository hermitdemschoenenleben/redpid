...
csr = {
    ...
    'control_loop_sequence_player_max_state': (0, 0x07b, 10, True),
    'control_loop_sequence_player_last_point': (0, 0x07d, 14, True),
    'control_loop_sequence_player_request_stop': (0, 0x07f, 1, True),
    'control_loop_sequence_player_stop_zone': (0, 0x080, 3, True),
    'control_loop_sequence_player_request_recording': (0, 0x081, 1, True),
    'control_loop_sequence_player_record_after': (0, 0x082, 20, True),
    'control_loop_sequence_player_data_out': (0, 0x085, 14, False),
    'control_loop_sequence_player_data_out_addr': (0, 0x087, 14, True),
    'control_loop_sequence_player_error_signal_out': (0, 0x089, 1, False),
    'control_loop_sequence_player_error_signal_out_addr': (0, 0x08a, 14, True),
    'control_loop_sequence_player_data_in': (0, 0x08c, 14, True),
    'control_loop_sequence_player_data_addr': (0, 0x08e, 14, True),
    'control_loop_sequence_player_data_write': (0, 0x090, 1, True),
    'control_loop_sequence_player_step_size': (0, 0x091, 14, True),
    'control_loop_sequence_player_decrease_step_size_after': (0, 0x093, 16, True),
    'control_loop_sequence_player_keep_constant_at_end': (0, 0x095, 14, True),
    'control_loop_sequence_player_zone_edge_0': (0, 0x097, 15, True),
    'control_loop_sequence_player_zone_edge_1': (0, 0x099, 15, True),
    'control_loop_sequence_player_zone_edge_2': (0, 0x09b, 15, True),
    'control_loop_sequence_player_ff_direction_0': (0, 0x09d, 2, True),
    'control_loop_sequence_player_ff_direction_1': (0, 0x09e, 2, True),
    'control_loop_sequence_player_ff_direction_2': (0, 0x09f, 2, True),
    'control_loop_sequence_player_ff_direction_3': (0, 0x0a0, 2, True),
    'control_loop_sequence_player_ff_curvature_0': (0, 0x0a1, 2, True),
    'control_loop_sequence_player_ff_curvature_filtering_start_0': (0, 0x0a2, 14, True),
    'control_loop_sequence_player_ff_curvature_1': (0, 0x0a4, 2, True),
    'control_loop_sequence_player_ff_curvature_filtering_start_1': (0, 0x0a5, 14, True),
    'control_loop_sequence_player_ff_curvature_2': (0, 0x0a7, 2, True),
    'control_loop_sequence_player_ff_curvature_filtering_start_2': (0, 0x0a8, 14, True),
    'control_loop_sequence_player_ff_curvature_3': (0, 0x0aa, 2, True),
    'control_loop_sequence_player_ff_curvature_filtering_start_3': (0, 0x0ab, 14, True),
    'control_loop_x_clr': (0, 0x0ad, 1, True),
    'control_loop_x_max': (0, 0x0ae, 25, False),
    'control_loop_x_min': (0, 0x0b2, 25, False),
    'control_loop_y_clr': (0, 0x0b6, 1, True),
    'control_loop_y_max': (0, 0x0b7, 25, False),
    'control_loop_y_min': (0, 0x0bb, 25, False),
    'control_loop_other_x_clr': (0, 0x0bf, 1, True),
    'control_loop_other_x_max': (0, 0x0c0, 25, False),
    'control_loop_other_x_min': (0, 0x0c4, 25, False),
    'control_loop_pid_out_clr': (0, 0x0c8, 1, True),
    'control_loop_pid_out_max': (0, 0x0c9, 25, False),
    'control_loop_pid_out_min': (0, 0x0cd, 25, False),
    'control_loop_x_hold_en': (0, 0x0d1, 27, True),
    'control_loop_x_clear_en': (0, 0x0d5, 27, True),
    'control_loop_y_hold_en': (0, 0x0d9, 27, True),
    'control_loop_y_clear_en': (0, 0x0dd, 27, True),
    'control_loop_dx_sel': (0, 0x0e1, 3, True),
    'control_loop_dy_sel': (0, 0x0e2, 3, True),
    'control_loop_rx_sel': (0, 0x0e3, 3, True),
