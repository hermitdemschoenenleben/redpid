...
csr = {
    ...
    'fast_a_sequence_player_enabled': (0, 0x086, 1, True),
    'fast_a_sequence_player_data_in': (0, 0x087, 28, True),
    'fast_a_sequence_player_data_addr': (0, 0x08b, 13, True),
    'fast_a_sequence_player_recording': (0, 0x08d, 1, True),
    'fast_a_sequence_player_data_out': (0, 0x08e, 14, False),
    'fast_a_sequence_player_data_out_addr': (0, 0x090, 14, True),
    'fast_a_x_clr': (0, 0x092, 1, True),
    'fast_a_x_max': (0, 0x093, 25, False),
    'fast_a_x_min': (0, 0x097, 25, False),
    'fast_a_y_clr': (0, 0x09b, 1, True),
    'fast_a_y_max': (0, 0x09c, 25, False),
    'fast_a_y_min': (0, 0x0a0, 25, False),
    'fast_a_sweep_trigger_clr': (0, 0x0a4, 1, True),
    'fast_a_sweep_trigger_max': (0, 0x0a5, 1, False),
    'fast_a_sweep_trigger_min': (0, 0x0a6, 1, False),
    'fast_a_x_hold_en': (0, 0x0a7, 27, True),
    'fast_a_x_clear_en': (0, 0x0ab, 27, True),
    'fast_a_y_hold_en': (0, 0x0af, 27, True),
    'fast_a_y_clear_en': (0, 0x0b3, 27, True),
    'fast_a_relock_en': (0, 0x0b7, 27, True),
    'fast_a_dx_sel': (0, 0x0bb, 5, True),
    'fast_a_dy_sel': (0, 0x0bc, 5, True),
    'fast_a_rx_sel': (0, 0x0bd, 5, True),
    ...
    'fast_b_sequence_player_enabled': (1, 0x086, 1, True),
    'fast_b_sequence_player_dcycle': (1, 0x087, 14, True),
    'fast_b_x_clr': (1, 0x089, 1, True),
    'fast_b_x_max': (1, 0x08a, 25, False),
    'fast_b_x_min': (1, 0x08e, 25, False),
    'fast_b_y_clr': (1, 0x092, 1, True),
    'fast_b_y_max': (1, 0x093, 25, False),
    'fast_b_y_min': (1, 0x097, 25, False),
    'fast_b_sweep_trigger_clr': (1, 0x09b, 1, True),
    'fast_b_sweep_trigger_max': (1, 0x09c, 1, False),
    'fast_b_sweep_trigger_min': (1, 0x09d, 1, False),
    'fast_b_x_hold_en': (1, 0x09e, 27, True),
    'fast_b_x_clear_en': (1, 0x0a2, 27, True),
    'fast_b_y_hold_en': (1, 0x0a6, 27, True),
    'fast_b_y_clear_en': (1, 0x0aa, 27, True),
    'fast_b_relock_en': (1, 0x0ae, 27, True),
    'fast_b_dx_sel': (1, 0x0b2, 5, True),
    'fast_b_dy_sel': (1, 0x0b3, 5, True),
    'fast_b_rx_sel': (1, 0x0b4, 5, True),
