...
csr = {
    ...
    'control_loop_sequence_player_stop_algorithm_after': (0, 0x07b, 20, True),
    'control_loop_sequence_player_max_state': (0, 0x07e, 10, True),
    'control_loop_sequence_player_last_point': (0, 0x080, 14, True),
    'control_loop_sequence_player_request_stop': (0, 0x082, 1, True),
    'control_loop_sequence_player_stop_after': (0, 0x083, 20, True),
    'control_loop_sequence_player_stop_zone': (0, 0x086, 3, True),
    'control_loop_sequence_player_request_recording': (0, 0x087, 1, True),
    'control_loop_sequence_player_record_after': (0, 0x088, 20, True),
    'control_loop_sequence_player_data_out': (0, 0x08b, 14, False),
    'control_loop_sequence_player_data_out_addr': (0, 0x08d, 14, True),
    'control_loop_sequence_player_error_signal_out': (0, 0x08f, 1, False),
    'control_loop_sequence_player_error_signal_out_addr': (0, 0x090, 14, True),
    'control_loop_sequence_player_data_in': (0, 0x092, 14, True),
    'control_loop_sequence_player_data_addr': (0, 0x094, 14, True),
    'control_loop_sequence_player_data_write': (0, 0x096, 1, True),
    'control_loop_sequence_player_step_size': (0, 0x097, 14, True),
    'control_loop_sequence_player_decrease_step_size_after': (0, 0x099, 16, True),
    'control_loop_sequence_player_keep_constant_at_end': (0, 0x09b, 14, True),
    'control_loop_sequence_player_zone_edge_0': (0, 0x09d, 15, True),
    'control_loop_sequence_player_zone_edge_1': (0, 0x09f, 15, True),
    'control_loop_sequence_player_zone_edge_2': (0, 0x0a1, 15, True),
    'control_loop_sequence_player_ff_direction_0': (0, 0x0a3, 2, True),
    'control_loop_sequence_player_ff_direction_1': (0, 0x0a4, 2, True),
    'control_loop_sequence_player_ff_direction_2': (0, 0x0a5, 2, True),
    'control_loop_sequence_player_ff_direction_3': (0, 0x0a6, 2, True),
    'control_loop_sequence_player_ff_curvature_0': (0, 0x0a7, 2, True),
    'control_loop_sequence_player_ff_curvature_filtering_start_0': (0, 0x0a8, 14, True),
    'control_loop_sequence_player_ff_curvature_1': (0, 0x0aa, 2, True),
    'control_loop_sequence_player_ff_curvature_filtering_start_1': (0, 0x0ab, 14, True),
    'control_loop_sequence_player_ff_curvature_2': (0, 0x0ad, 2, True),
    'control_loop_sequence_player_ff_curvature_filtering_start_2': (0, 0x0ae, 14, True),
    'control_loop_sequence_player_ff_curvature_3': (0, 0x0b0, 2, True),
    'control_loop_sequence_player_ff_curvature_filtering_start_3': (0, 0x0b1, 14, True),
    'control_loop_x_clr': (0, 0x0b3, 1, True),
    'control_loop_x_max': (0, 0x0b4, 25, False),
    'control_loop_x_min': (0, 0x0b8, 25, False),
    'control_loop_y_clr': (0, 0x0bc, 1, True),
    'control_loop_y_max': (0, 0x0bd, 25, False),
    'control_loop_y_min': (0, 0x0c1, 25, False),
    'control_loop_other_x_clr': (0, 0x0c5, 1, True),
    'control_loop_other_x_max': (0, 0x0c6, 25, False),
    'control_loop_other_x_min': (0, 0x0ca, 25, False),
    'control_loop_pid_out_clr': (0, 0x0ce, 1, True),
    'control_loop_pid_out_max': (0, 0x0cf, 25, False),
    'control_loop_pid_out_min': (0, 0x0d3, 25, False),
    'control_loop_x_hold_en': (0, 0x0d7, 27, True),
    'control_loop_x_clear_en': (0, 0x0db, 27, True),
    'control_loop_y_hold_en': (0, 0x0df, 27, True),
    'control_loop_y_clear_en': (0, 0x0e3, 27, True),
    'control_loop_dx_sel': (0, 0x0e7, 3, True),
    'control_loop_dy_sel': (0, 0x0e8, 3, True),
    'control_loop_rx_sel': (0, 0x0e9, 3, True),
