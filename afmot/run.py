...
if __name__ == '__main__':
    ...
    # einseitiger test: mean-ofsets:
    # [3, 10, 50, 100, 250, 400, 700, 1000, 1500, 2000, 10, without]

    # zweiseitiger Test:
    # * mit PID: -20, -1, -100
    # * ohne PID, aber mit Kanal durchgeschleift
    # * ohne PID, ohne Kanal durchgeschleift
    # * ohne PID, ohne Kanal, mit Algorithmus
    # * mit Algorithmus und I (-1)
    # * mit Algorithmus und PID komplett
    ...
    #rp.pitaya.set('control_loop_sequence_player_curvature_1', -1)

    #rp.pitaya.set('control_loop_sequence_player_mean_start', 10)
    #asd
    switch = 1
    ...
    for wait in (3.5, 4.5, 5.5, 6.5):
        ...
        rp.pitaya.set('control_loop_sequence_player_tuning_direction_0', -1 * switch)
        rp.pitaya.set('control_loop_sequence_player_tuning_direction_1', 1 * switch)
        #rp.pitaya.set('control_loop_sequence_player_curvature_0', 1 * switch)
        #rp.pitaya.set('control_loop_sequence_player_curvature_1', -1 * switch)
        rp.pitaya.set('control_loop_sequence_player_curvature_0', 1)
        rp.pitaya.set('control_loop_sequence_player_curvature_1', 1)
        ...
        rp.pitaya.set('control_loop_sequence_player_max_status', 4)
